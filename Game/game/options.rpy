...
define config.name = _("La Voie de la Pastèque")
...
define build.name = "LaVoiedelaPasteque"
...
define config.save_directory = "LaVoiedelaPasteque-1556999138"
